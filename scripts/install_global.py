...
def install_bootstrap(dst:Path):
    ...
    for rel in ['commands/hhc-install.md','commands/hhc-install-remote.md','commands/hhc-reconfigure.md','commands/hhc-update.md']:
...
def main()->int:
    ...
    print('Artık /hhc-install ile kurabilir, /hhc-reconfigure ile profil/rol/model ayarlarını sonradan değiştirebilir, /hhc-update ile güncelleyebilirsiniz.')
    return 0
